...
kitsanity_locations = {
    ...
    "TRR Villian #1 - Room 1, Pull garbage cans with strong character":                     LegoBatman1LocationData("The Riddler Makes a Withdrawal",   45035996178),
    "TRR Villian #1 - Room 1, Pull white truck in parking lot then double jump up":         LegoBatman1LocationData("The Riddler Makes a Withdrawal",   45035996177),
    "TRR Villian #1 - Room 1, Drive Blue car to machine in bottom right of parking lot":    LegoBatman1LocationData("The Riddler Makes a Withdrawal",   45035996179),    
    "TRR Villian #1 - Room 2, Break silver window near glass":                              LegoBatman1LocationData("The Riddler Makes a Withdrawal",   45035996181),
    "TRR Villian #1 - Room 2, Batarang window then grapple up to it":                       LegoBatman1LocationData("The Riddler Makes a Withdrawal",   45035996182),
    "TRR Villian #1 - Room 2, Break glass window with tv after silver gate":                LegoBatman1LocationData("The Riddler Makes a Withdrawal",   45035996183),
    "TRR Villian #1 - Room 3, Double jump on rails near entrance":                          LegoBatman1LocationData("The Riddler Makes a Withdrawal",   45035996185),
    "TRR Villian #1 - Room 3, Break barrels left side of bank":                             LegoBatman1LocationData("The Riddler Makes a Withdrawal",   45035996186),
    "TRR Villian #1 - Room 3, Break glass window near ladder":                              LegoBatman1LocationData("The Riddler Makes a Withdrawal",   45035996187),
    "TRR Villian #1 - Room 3, Blow up silver object near police car":                       LegoBatman1LocationData("The Riddler Makes a Withdrawal",   45035996188),
    # On the Rocks
