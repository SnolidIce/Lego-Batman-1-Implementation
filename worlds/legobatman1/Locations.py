...
location_table: Dict[str, LegoBatman1LocationData] = {
    ...
    "TRR Hero #2 - Room 1, Enemies inside Mind Control Door left of spawn":                 LegoBatman1LocationData("An Icy Reception",   45035996015),
    ...
    "TRR Hero #4 - Room 2, Glass Wall":                                                     LegoBatman1LocationData("A Poisonous Appointment",   45035996038),
    ...
    "TRR Hero #5 - Room 1, Use Attract Machine and Double Jump on Leaves":                  LegoBatman1LocationData("The Face-Off",   45035996051),
    ...
    "PCP Hero #3 - Room 1, Far Right enemy":                                                LegoBatman1LocationData("Under The City",   45035996083),
    ...
    "PCP Hero #5 - Room 1, Fight enemies right side of room":                               LegoBatman1LocationData("Penguin's Lair",   45035996109),
    ...
    "TJR Hero #2 - Room 1, Use Tech Pannel on duck game, then destory all ducks":           LegoBatman1LocationData("Little Fun at the Big Top",   45035996133),
    ...
    # Flight of the Bat
    "TJR Hero #3 - Room 1, Destory all 6 missle launchers":                                 LegoBatman1LocationData("Flight of the Bat",   45035996142),
    ...
    "TJR Hero #4 - Room 1, Destory 3 cakes":                                                LegoBatman1LocationData("In the Dark Night",   45035996156),
    ...
    "TRR Villian #2 - Room 2, Break silver handle then go insides":                            LegoBatman1LocationData("On the Rocks",   45035996192),
    ...
    "TRR Villian #4 - Room 2, Blow up silver gate, then build helicopter, use tech suit and fly to middle of room":LegoBatman1LocationData("TAn Enterprising Theft",   45035996218),
    ...
    "TRR Villian #5 - Room 4, Destory 4 gold items":                                           LegoBatman1LocationData("Breaking Blocks",   45035996242),
    ...
    "TJR Villian #1 - Room 2, Glide across from near generator then grapple and blow up silver object":LegoBatman1LocationData("A Surprise for the Commissioner",   45035996313),
    ...
    "TJR Villian #2 - Break 5 police copters throughout the level":                            LegoBatman1LocationData("Biplane Blast",   45035996318),
